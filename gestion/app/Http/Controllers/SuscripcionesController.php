...
class SuscripcionesController extends Controller
{
    ...
    public function suscripciones()
    {
        ...
        $suscripciones = DB::table('suscripciones')
            ->select('suscripciones.id','suscripciones.numeropedido','suscripciones.numerofactura','suscripciones.fechainicio','suscripciones.fechafinal','suscripciones.estado','suscripciones.tiposuscripcion','suscripciones.nombre',DB::raw('COUNT(despachos.idsuscripcion) as total'))
            ->leftjoin('despachos', 'suscripciones.id', '=', 'despachos.idsuscripcion')
            ->groupBy('suscripciones.id')
            ->orderBy('suscripciones.estado','ASC')
            ->orderBy('suscripciones.fechainicio','DESC')->get();
    ...
    public function store(Request $request)
    {
        ...
        $suscripciones = DB::table('suscripciones')
            ->select('suscripciones.id','suscripciones.numeropedido','suscripciones.numerofactura','suscripciones.fechainicio','suscripciones.fechafinal','suscripciones.estado','suscripciones.tiposuscripcion','suscripciones.molienda','suscripciones.cantidad','suscripciones.nombre',DB::raw('COUNT(despachos.idsuscripcion) as total'))
            ->leftjoin('despachos', 'suscripciones.id', '=', 'despachos.idsuscripcion')
    ...
    public function edit($id)
    {
        ...
        $despachos = DB::table('despachos')
            ...
            ->where('suscripciones.id', '=', $id)
            ->orderBy('despachos.fechadespacho','ASC')
            ->get();

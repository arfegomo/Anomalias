...
<div class="panel panel-default ">
                        ...
                        <ul class="timeline">
                            <!--<li>
                             ...
                             <li>
                                ...
                                <div class="timeline-panel">
                                    <div class="timeline-heading">
                                        <a href="{{ route('aumento-seguidores') }}"><h4 class="timeline-title">Camapaña Aumento Seguidores</h4></a>
                                    </div>
                                     <div class="timeline-body">
 <a href="https://docs.google.com/spreadsheets/d/1AcxI_nOP-_BVNZGqylyHydtjK1JEGC-JZ4riphfjI14/edit?usp=sharing" target="_blank"><h5 class="timeline-title"><i class="glyphicon glyphicon-hand-right"></i> Ver respuestas </h5></a>
                            ...
                            <li>
                                ...
                                <div class="timeline-panel">
                                    <div class="timeline-heading">
                                        <a href="{{ route('formato-8') }}"><h4 class="timeline-title">CONTROL ENTREGA DE TARJETAS</h4></a>
                                    </div>
                                    <!--<div class="timeline-body">
                            ...
                            <li>
                                ...
                                <div class="timeline-panel">
                                    <div class="timeline-heading">
                                       <a href="{{ route('formato-9') }}"><h4 class="timeline-title">CONTROL DE SELLOS</h4></a>
                                    </div>
                                    <!--<div class="timeline-body">
                            ...
                            <li>
                                ...
                                <div class="timeline-panel">
                                    <div class="timeline-heading">
                                        <a href="{{ route('formato-10') }}"><h4 class="timeline-title">CONTROL DE BEBIDAS</h4></a>
                                    </div>
                                     <!--<div class="timeline-body">
 							...
 							<li>
                                ...
                                <div class="timeline-panel">
                                    <div class="timeline-heading">
                                        <a href="{{ route('calidad-productos',array('id'=>2)) }}"><h4 class="timeline-title">Reportar anomalía mercadeo</h4></a>
                                    </div>
                                     <!--<div class="timeline-body">
                                        <a href="https://docs.google.com/spreadsheets/d/1Ehf6Ms4BukGU84tu4tHh3JwSiwTVvaBnaqkampc0Q8k/edit?usp=sharing" target="_blank"><h5 class="timeline-title"><i class="glyphicon glyphicon-hand-right"></i> Ver respuestas </h5></a>
                                    </div>-->

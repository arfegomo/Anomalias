...
{!! Form::open(['route' => 'respuestas.store']) !!}
    ...
    @elseif($detalleevaluacion->momento == 2)
    {!! Form::text('momento','Auditoría', ['class' => 'form-control','readonly' => 'readonly']) !!}
    @else
    {!! Form::text('momento','Cliente Institucional', ['class' => 'form-control','readonly' => 'readonly']) !!}
    @endif
    </div>
...
<div class="form-group">
    {!! Form::Label('item', 'Tipo de incidente:') !!}
    @if($detalleevaluacion->tipoincidente == 1)
    {!! Form::text('tipoincidente','Anomalia', ['class' => 'form-control','readonly' => 'readonly']) !!}
    @else
    {!! Form::text('tipoincidente','Producto no conforme', ['class' => 'form-control','readonly' => 'readonly']) !!}
    @endif
</div>

<div class="form-group">
    {!! Form::Label('item', 'Fecha identificación:') !!}
    {!! Form::text('fechaidentificacion',$detalleevaluacion->fechaidentificacion, ['class' => 'form-control','readonly' => 'readonly']) !!}
</div>

<div class="form-group">
    {!! Form::Label('item', 'Lugar donde se identificó:') !!}
    @if($detalleevaluacion->lugaridentificado == 1)
    {!! Form::text('lugaridentificado','Recepción', ['class' => 'form-control','readonly' => 'readonly']) !!}
    @elseif($detalleevaluacion->lugaridentificado == 2)
    {!! Form::text('lugaridentificado','Almacenado o exhibido', ['class' => 'form-control','readonly' => 'readonly']) !!}
    @elseif($detalleevaluacion->lugaridentificado == 3)
    {!! Form::text('lugaridentificado','Entrega al cliente', ['class' => 'form-control','readonly' => 'readonly']) !!}
    @endif
</div>

<div class="form-group">
    {!! Form::Label('item', 'Fecha de recepción:') !!}
    {!! Form::text('fecharecepcion',$detalleevaluacion->fecharecepcion, ['class' => 'form-control','readonly' => 'readonly']) !!}
</div>

<div class="form-group">
    {!! Form::Label('item', 'Cantidad:') !!}
    {!! Form::text('cantidad',$detalleevaluacion->cantidad, ['class' => 'form-control','readonly' => 'readonly']) !!}
</div>

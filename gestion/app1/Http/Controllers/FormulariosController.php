...
class FormulariosController extends Controller
{
    ...
    public function loadGrupoEvaluacionAll()
    {
        $evaluaciones = DB::table('formularios')
            ...
            ->select('productos.nombre as nombre_producto','formularios.id','tiendas.nombre as nombre_tienda','formularios.created_at','formularios.estado',DB::raw('COUNT(respuestas.idformulario) as total'))
            ->groupBy('formularios.id')->get();

                    ...
                    <div class="panel-body timeline-container">
                        <ul class="timeline">
                            ...
                            <li>
                                ...
                                <div class="timeline-panel">
                                    <div class="timeline-heading">
                                        <a href="http://200.6.174.84/maquinas/login_maquinas.php" target="_blank"><h4 class="timeline-title">Tickets mantenimiento</h4></a>
                                    </div>
                                    <div class="timeline-body">
                            ...
                            <li>
                                ...
                                <div class="timeline-panel">
                                    <div class="timeline-heading">
                                       <a href="http://200.6.174.84/equiposdecomputo/login_sistemas.php" target="_blank"><h4 class="timeline-title">Tickets sistemas</h4></a>
                                    </div>
                                    <div class="timeline-body">
                                        <!--<p>Lorem ipsum dolor sit amet, consectetur adipiscing elit. Integer at sodales nisl. Donec malesuada orci ornare risus finibus feugiat.</p>-->
                                    </div>
                            ...
                            <li>
                                ...
                                <div class="timeline-panel">
                                    <div class="timeline-heading">
                                        <a href="<?php echo e(route('formatos-mercadeo')); ?>"><h4 class="timeline-title">Formatos Mercadeo</h4></a>
                                    </div>
                                    <div class="timeline-body">
                                        <!--<p>Lorem ipsum dolor sit amet, consectetur adipiscing elit.</p>-->
                                    </div>
                            ...
                            <li>
                                ...
                                <div class="timeline-panel">
                                    <div class="timeline-heading">
                                        <a href="http://200.6.174.84/wifis/software/index2.php" target="_blank"><h4 class="timeline-title">Consulta de claves wifi</h4></a>
                                    </div>
                                    <!--<div class="timeline-body">
                                        <p>Lorem ipsum dolor sit amet, consectetur adipiscing elit.</p>
                                    </div>-->
                            ...
                            <!--<li>
                                ...
                                <div class="timeline-panel">
                                    <div class="timeline-heading">
                                        <a href="<?php echo e(route('factura-electronica')); ?>"><h4 class="timeline-title">Solictud factura personalizada</h4></a>
                                    </div>
                                    <div class="timeline-body">
                                        <p>Lorem ipsum dolor sit amet, consectetur adipiscing elit.</p>
                                    </div>
                            ...
                            <li>
                                ...
                                <div class="timeline-panel">
                                    <div class="timeline-heading">
                                        <!--<a href="<?php echo e(route('covid-19')); ?>"><h4 class="timeline-title">Seguimiento covid-19</h4></a>-->
                                        <a href="<?php echo e(route('manuales')); ?>"><h4 class="timeline-title">Manuales</h4></a>
                                    </div>
                                    <div class="timeline-body">
                                        <!--<p>Lorem ipsum dolor sit amet, consectetur adipiscing elit.</p>-->
                                    </div>
                            ...
                            <li>
                                ...
                                <div class="timeline-panel">
                                    <div class="timeline-heading">
                                        <a href="<?php echo e(route('covid-19-terrazacafe')); ?>"><h4 class="timeline-title">Registro de personas (Terraza Cafe)</h4></a>
                                    </div>
                                    <div class="timeline-body">
                                        <!--<p>Lorem ipsum dolor sit amet, consectetur adipiscing elit.</p>-->
                                    </div>

<?php $__env->startSection('titulo','Editar proveedores'); ?>
...
<?php echo Form::model($proveedores, ['route' => ['proveedores.update', $proveedores->id],'method'=>'PUT']); ?>
   ...
   <?php echo Form::text('nit',null,array(
    ...
    <div class="form-group">
    <?php echo Form::submit('Actualizar proveedor', array('class'=>'btn btn-warning')); ?>

                    ...
                    <div class="panel-body timeline-container">
                        <ul class="timeline">
                            ...
                            <li>
                                ...
                                <div class="timeline-panel">
                                    <div class="timeline-heading">
                                        <a href="<?php echo e(route('formato-2')); ?>"><h4 class="timeline-title">FORMATO DE CONTROL DE TEMPERATURA DE REFRIGERACIÓN DE VITRINA EXHIBIDORA</h4></a>
                                    </div>
                                    <div class="timeline-body">
                            ...
                            <li>
                                ...
                                <div class="timeline-panel">
                                    <div class="timeline-heading">
                                       <a href="<?php echo e(route('formato-3')); ?>"><h4 class="timeline-title">FORMATO DE CONTROL DE TEMPERATURA DE REFRIGERACIÓN DE NEVERA</h4></a>
                                    </div>
                                    <div class="timeline-body">
                            ...
                            <li>
                                ...
                                <div class="timeline-panel">
                                    <div class="timeline-heading">
                                        <a href="<?php echo e(route('formato-4')); ?>"><h4 class="timeline-title">FORMATO DE CONTROL DE TEMPERATURA DE CONGELACIÓN</h4></a>
                                    </div>
                                    <div class="timeline-body">
                            ...
                            <li>
                                ...
                                <div class="timeline-panel">
                                    <div class="timeline-heading">
                                        <a href="<?php echo e(route('formato-5')); ?>"><h4 class="timeline-title">FORMATO DE CONTROL DE LIMPIEZA Y DESINFECCIÓN</h4></a>
                                    </div>
                                     <div class="timeline-body">
                            ...
                            <!--<li>
                                ...
                                <div class="timeline-panel">
                                    <div class="timeline-heading">
                                        <a href="<?php echo e(route('formato-6')); ?>"><h4 class="timeline-title">FORMATO CONTROL DE PRODUCTO NO CONFORME</h4></a>
                                    </div>
                                    <div class="timeline-body">
                            ...
                            <li>
                                ...
                                <div class="timeline-panel">
                                    <div class="timeline-heading">
                                        <a href="<?php echo e(route('formato-7')); ?>"><h4 class="timeline-title">FORMATO CONTROL DE DOSIFICACIÓN DE PRODUCTOS DE LIMPIEZA Y DESIFECCIÓN</h4></a>
                                    </div>
                                    <div class="timeline-body">
                              ...
                              <li>
                                ...
                                <div class="timeline-panel">
                                    <div class="timeline-heading">
                                        <a href="<?php echo e(route('formato-11')); ?>"><h4 class="timeline-title">FORMATO DE CONTROL DE LIMPIEZA Y DESINFECCIÓN FREE ZONE</h4></a>
                                    </div>
                            ...
                            <li>
                                ...
                                <div class="timeline-panel">
                                    <div class="timeline-heading">
                                        <a href="<?php echo e(route('formato-12')); ?>"><h4 class="timeline-title">FORMATO CONTROL DE DOSIFICACIÓN DE PRODUCTOS DE LIMPIEZA Y DESIFECCIÓN FREE ZONE</h4></a>
                                    </div>
